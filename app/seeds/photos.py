...
def seed_photos():
    ...
    fourth_photo = Photo(
        image_url='https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821__340.jpg', title='4 Photo', description='This is the 4th photo', user_id=1, album_id=2)
    fifth_photo = Photo(
    ...
    sixth_photo = Photo(
        image_url='https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821__340.jpg', title='6 Photo', description='This is the 6th photo', user_id=1, album_id=2)
    seventh_photo = Photo(
        image_url='https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821__340.jpg', title='7 Photo', description='This is the 7th photo', user_id=2, album_id=1)
    eighth_photo = Photo(
        image_url='https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821__340.jpg', title='8 Photo', description='This is the 8th photo', user_id=2, album_id=1)
    ninth_photo = Photo(
        image_url='https://cdn.pixabay.com/photo/2015/12/01/20/28/road-1072821__340.jpg', title='9 Photo', description='This is the 9th photo', user_id=2, album_id=1)
    tenth_photo = Photo(
